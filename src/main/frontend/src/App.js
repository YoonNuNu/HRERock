...
import MoviePersonal from './movie/pages/MoviePersonal';
        ...
        <BrowserRouter>
            ...
            <Routes>
                ...
                <Route path="/" element={<CustomerOutlet />} >
                    ...
                    <Route path="/user/MoviePlay/:movieId" element={<MoviePlayPage />} />
                    ...
                    <Route path="/user/MoviePersonal" element={<MoviePersonal />} />
                </Route>
