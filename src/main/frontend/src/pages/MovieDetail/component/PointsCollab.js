...
const PointsCollab = ({ memNum }) => {
    ...
    const fetchPointsCollabList = useCallback(async () => {
        ...
        try {
            setLoading(true);
            const response = await axios.get(`/user/personal/recommend/${memNum}/points-collab`, {
