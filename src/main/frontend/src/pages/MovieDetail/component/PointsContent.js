...
const PointsContent = ({ memNum }) => {
    ...
    const fetchPointsContentList = useCallback(async () => {
        ...
        try {
            setLoading(true);
            const response = await axios.get(`/user/personal/recommend/${memNum}/points-content`, {
