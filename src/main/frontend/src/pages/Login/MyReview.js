...
import { FaTimes } from 'react-icons/fa'; // X 아이콘을 위해 react-icons 라이브러리 추가
                        ...
                        <div className="myreview-item" key={index}>
                            ...
                            <div className="myreview-content">
                                <div className="myreview-poster">
                                    <Link to={`/user/MoviePage/${review.movieId}`}>
                                        <img src={review.poster?.posterUrls || '/path/to/default/poster.jpg'}
                                ...
                                <div className="myreview-details">
                                    ...
                                    <div className="myreview-meta">
                                        ...
                                        <span
                                            className="myreview-rating">{'★'.repeat(Math.round(review.reviewRating))}</span>
                                    </div>
                                    <div className="review-points">
                                        <div className="points-container">
                                            <span className="points-label">매력 포인트:</span>
                                        ...
                                        <div className="points-container">
                                            <span className="points-label">감정 포인트:</span>
