...
// import '../Login/css/MyPage.css';
//
// const DraggableMovieItem = ({ movie, showPlayButton, showProgressBar, progressPercentage }) => {
//     const [{ isDragging }, drag] = useDrag(() => ({
//         type: 'watch-history',
//         item: { id: movie.watchId, type: 'watch-history' },
//         collect: (monitor) => ({
//             isDragging: !!monitor.isDragging(),
//         }),
//     }));
...
//
//     if (loading) {
//         return <div className="mypage-loading">Loading...</div>;
//     }
//
//     return (
//         <DndProvider backend={HTML5Backend}>
